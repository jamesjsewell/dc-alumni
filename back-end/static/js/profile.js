...
github
:
"http://www.github.com/ericmschow"
isActive
:
true
linkedin
:
"http://www.linkedin.com/in/ericmschow"
lname
:
"Schow"
portfolio
...
resume
:
"http://www.ericmschow.com/resume.pdf"
tag
*/
...
Vue.component('profile', {
  template: `<div id='profileContainer' class="row">
	<form class="form-horizontal profileForm col-sm-offset-2 col-sm-10" method=POST action="">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control" id="linkedin" placeholder="Link to your LinkedIn account.">
    </div>
  </div>
	<div class="form-group">
		<label for="portfolio" class="col-sm-2 control-label">Portfolio</label>
		<div class="col-sm-9">
			<input type="text" class="form-control" id="portfolio" placeholder="Link to your personal portfolio.">
		</div>
	</div>
	<div class="form-group">
		<label for="resume" class="col-sm-2 control-label">Resume</label>
		<div class="col-sm-9">
			<input type="text" class="form-control" id="resume" placeholder="Link to your resume, hosted on your portfolio.">
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<textarea class="form-control" rows="5" id="description" placeholder="Put your elevator pitch here."></textarea>
		</div>
	</div>
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
			<div class="checkbox">
				<label><input type="checkbox" checked value="">Check here if you would like to appear in the alumni registry.</label>
			</div>
		</div>
	</div>
	<div class="form-group">
